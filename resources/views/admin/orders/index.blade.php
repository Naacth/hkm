    ...
    <div class="container">
        ...
        <div class="orders-table-card bg-white rounded-4 shadow-lg overflow-hidden">
            <div class="table-header bg-light p-4 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.orders.export-orders') }}" class="btn btn-success btn-sm rounded-pill">
                        ...
                        <tr class="order-row">
                            ...
                            <td class="px-4 py-3">
                                <div class="customer-info">
                                    ...
                                    <p class="text-muted small mb-0">{{ $order->customer_email }}</p>
                                    <p class="text-muted small mb-0">{{ $order->customer_phone }}</p>
                                </div>
                            </td>
                            <td class="px-4 py-3">
                                <div class="product-info">
                                    <h6 class="fw-bold text-primary mb-1">{{ $order->produk->name }}</h6>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <form action="{{ route('admin.orders.update-status', $order->id) }}" method="POST" class="d-inline">
                                                    ...
                                                    <button type="submit" class="dropdown-item {{ $order->status == 'confirmed' ? 'active' : '' }}">
                                            ...
                                            <li>
                                                <form action="{{ route('admin.orders.update-status', $order->id) }}" method="POST" class="d-inline">
                                                    ...
                                                    <button type="submit" class="dropdown-item text-danger {{ $order->status == 'cancelled' ? 'active' : '' }}">
