@extends('layout')
@section('title', 'Detail Pesanan ' . $order->order_number . ' | HIMAKOM UYM')
@section('content')

<!-- Hero Section -->
<div class="hero-section position-relative overflow-hidden" style="background: linear-gradient(135deg, #1976d2 0%, #3F3F9C 100%); min-height: 30vh; display: flex; align-items: center;">
    <div class="container position-relative z-3">
        <div class="row justify-content-center text-center">
            <div class="col-lg-8">
                <div class="hero-content text-white">
                    <h1 class="display-6 fw-bold mb-4 animate__animated animate__fadeInUp">
...
<div class="order-detail-section py-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="order-detail-card bg-white rounded-4 shadow-lg p-5">
                    <!-- Order Header -->
                    <div class="order-header text-center mb-5">
                        <div class="order-status-badge mb-3">
                            <span class="badge {{ $order->getStatusBadgeClass() }} fs-5 px-4 py-3">
                    ...
                    <div class="action-buttons text-center mt-5">
                        ...
                        <a href="{{ route('orders.history') }}" class="btn btn-outline-primary btn-lg rounded-pill px-5">
