@extends('layout')
@section('title', 'Sertifikat Saya | HIMAKOM UYM')
@section('content')
    ...
    <div class="container">
                            ...
                            <div class="certificate-info">
                                ...
                                <div class="info-grid">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span>Tersedia sejak: {{ $registration->updated_at->format('d M Y') }}</span>
                                    </div>
                                    @if($registration->certificate_downloaded)
                                    <div class="info-item">
                                        <i class="bi bi-download text-primary me-2"></i>
                                        <span class="text-info">Terakhir didownload: {{ $registration->updated_at->format('d M Y, H:i') }}</span>
                                    </div>
                                    @endif
                                </div>
                            </div>
        ...
        <div class="empty-state text-center py-5">
            ...
            <div class="d-flex gap-3 justify-content-center">
                <a href="{{ route('event-registrations.history') }}" class="btn btn-primary btn-lg rounded-pill">
                    <i class="bi bi-clock-history me-2"></i>Lihat Riwayat Pendaftaran
                </a>
                <a href="{{ route('event') }}" class="btn btn-outline-primary btn-lg rounded-pill">
