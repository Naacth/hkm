<?php $__env->startSection('title', 'Event | HIMAKOM UYM'); ?>
<?php $__env->startSection('meta_description', 'Daftar event dan kegiatan HIMAKOM UYM: workshop, seminar, lomba, dan lainnya.'); ?>
<?php $__env->startSection('jsonld'); ?>
{
  ...
  "itemListElement": [
    <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    {
      "&#64;type": "Event",
      "name": "<?php echo e(addslashes($e->title)); ?>",
      "startDate": "<?php echo e(\Carbon\Carbon::parse($e->date)->toIso8601String()); ?>",
      <?php if($e->location): ?>"location": {"&#64;type": "Place", "name": "<?php echo e(addslashes($e->location)); ?>"},<?php endif; ?>
      <?php if($e->image): ?>"image": "<?php echo e($e->image_url); ?>",<?php endif; ?>
      "description": "<?php echo e(addslashes(Str::limit($e->description, 160))); ?>",
                    ...
                    <div class="stats-row animate__animated animate__fadeInUp animate__delay-2s">
                        <div class="row justify-content-center">
                            <div class="col-4 col-md-3">
                                <div class="stat-item">
                                    <div class="stat-number fw-bold"><?php echo e($events->count()); ?></div>
                                    <div class="stat-label">Total Event</div>
                                </div>
                            </div>
                            <div class="col-4 col-md-3">
                                <div class="stat-item">
                                    <div class="stat-number fw-bold"><?php echo e($events->where('date', '>=', now())->count()); ?></div>
    ...
    <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="event-card card border-0 shadow-lg h-100 rounded-4 overflow-hidden transition-all animate__animated animate__fadeInUp" 
                     style="animation-delay: <?php echo e($index * 0.1); ?>s; transition: all 0.3s ease;"
                    ...
                    <div class="card-body p-4">
                        <h5 class="card-title fw-bold text-primary mb-3"><?php echo e($event->title); ?></h5>
                        ...
                        <div class="event-details mb-4">
                            <div class="detail-item d-flex align-items-center mb-2">
                                ...
                                <span class="text-muted"><?php echo e(\Carbon\Carbon::parse($event->date)->translatedFormat('l, d F Y')); ?></span>
                            </div>
                            <div class="detail-item d-flex align-items-center mb-2">
                                <i class="bi bi-clock text-primary me-3"></i>
                                <span class="text-muted"><?php echo e(\Carbon\Carbon::parse($event->date)->format('H:i')); ?> WIB</span>
                            </div>
                            <?php if($event->location): ?>
                            <div class="detail-item d-flex align-items-center mb-2">
                                <i class="bi bi-geo-alt text-primary me-3"></i>
                                <span class="text-muted"><?php echo e($event->location); ?></span>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="detail-item d-flex align-items-center">
                                <?php if($event->is_paid && $event->price): ?>
                                    ...
                                    <span class="text-success fw-semibold">Rp <?php echo e(number_format($event->price, 0, ',', '.')); ?></span>
                                <?php else: ?>
                        ...
                        <div class="event-actions">
                            ...
                            <?php if($event->registration_start_date || $event->registration_end_date): ?>
                                <div class="alert alert-info mb-3">
                                    <i class="bi bi-info-circle me-2"></i>
                                    <small><?php echo e($event->getRegistrationStatusMessage()); ?></small>
                                </div>
                            <?php endif; ?>

                            <?php if($event->event_type === 'public'): ?>
                                
                                <?php if($event->isRegistrationOpen() && $event->google_form_link): ?>
                                    <a href="<?php echo e($event->google_form_link); ?>" target="_blank" class="btn btn-info btn-sm rounded-pill w-100 mb-2">
                            ...
                            <?php else: ?>
                                ...
                                <?php if($event->isRegistrationOpen()): ?>
                                    <?php if(auth()->guard()->check()): ?>
                                        <a href="<?php echo e(route('event-registrations.create', $event)); ?>" class="btn btn-success btn-sm rounded-pill w-100 mb-2">
                                            <i class="bi bi-calendar-plus me-2"></i>Daftar Event
                                        </a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('login')); ?>?redirect=<?php echo e(urlencode(route('event-registrations.create', $event))); ?>" class="btn btn-primary btn-sm rounded-pill w-100 mb-2">
                                            <i class="bi bi-box-arrow-in-right me-2"></i>Login untuk Daftar
                                        </a>
                                    <?php endif; ?>
                                <?php elseif($event->isRegistrationNotStarted()): ?>
                            ...
                            <?php if($event->whatsapp_group_link): ?>
                                <?php if(auth()->guard()->check()): ?>
                                    <?php
                                        $userRegistration = \App\Models\EventRegistration::where('user_id', auth()->id())
                                            ...
                                            ->first();
                                    ?>
                                    <?php if($userRegistration && $userRegistration->canAccessWhatsAppGroup()): ?>
                                        <a href="<?php echo e(route('events.whatsapp.join', $userRegistration->id)); ?>" class="btn btn-outline-success btn-sm rounded-pill w-100 mb-2">
                            ...
                            <button type="button" 
                                    ...
                                    data-description="<?php echo e(strip_tags($event->description)); ?>"
                                    data-date="<?php echo e($event->getFormattedDateAttribute()); ?>"
                                    data-location="<?php echo e($event->location ?? 'Lokasi akan diumumkan'); ?>"
                                    data-raw-date="<?php echo e($event->date); ?>"
                                    data-is-paid="<?php echo e($event->is_paid ? 'true' : 'false'); ?>"
                                    data-price="<?php echo e($event->price ?? 0); ?>"
                                    data-qris="<?php echo e($event->qris_image_url ?? ''); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Nacht\Downloads\Himakom (4) (1)\Himakom\resources\views/event.blade.php ENDPATH**/ ?>