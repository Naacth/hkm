<?php $__env->startSection('title', 'Home | HIMAKOM UYM'); ?>
<?php $__env->startSection('meta_description', 'HIMAKOM UYM: organisasi mahasiswa Ilmu Komputer. Lihat event, produk, dan galeri terbaru.'); ?>
<?php $__env->startSection('jsonld'); ?>
{
  ...
  "url": "<?php echo e(url('/')); ?>",
  "logo": "<?php echo e(url('/logo-himakom.png')); ?>"
}
        ...
        <div class="row g-4 text-center">
            <div class="col-md-3">
                <div class="stat-card bg-white rounded-4 shadow-sm p-4">
                    ...
                    <h3 class="fw-bold text-primary mb-2 counter" data-target="<?php echo e($totalMembers ?? 50); ?>"><?php echo e($totalMembers ?? 50); ?>+</h3>
            ...
            <div class="col-md-3">
                <div class="stat-card bg-white rounded-4 shadow-sm p-4">
                    ...
                    <h3 class="fw-bold text-primary mb-2 counter" data-target="<?php echo e($totalEvents ?? 5); ?>"><?php echo e($totalEvents ?? 5); ?>+</h3>
            ...
            <div class="col-md-3">
                <div class="stat-card bg-white rounded-4 shadow-sm p-4">
                    ...
                    <h3 class="fw-bold text-primary mb-2 counter" data-target="<?php echo e($divisiCount ?? 5); ?>"><?php echo e($divisiCount ?? 5); ?>+</h3>
            ...
            <div class="col-md-3">
                <div class="stat-card bg-white rounded-4 shadow-sm p-4">
                    ...
                    <h3 class="fw-bold text-primary mb-2 counter" data-target="<?php echo e($upcomingEvents ?? 3); ?>"><?php echo e($upcomingEvents ?? 3); ?>+</h3>
...
<?php if($latestEvents && $latestEvents->count() > 0): ?>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="event-card bg-white rounded-4 shadow-sm h-100 overflow-hidden transition-all">
                    <div class="event-image-container position-relative">
                        <?php if($event->image): ?>
                            <img src="<?php echo e(asset('uploads/'.$event->image)); ?>" class="img-fluid w-100" style="height: 200px; object-fit: cover;" alt="<?php echo e($event->title); ?>">
                        <?php else: ?>
                        ...
                        <div class="event-badge position-absolute top-0 end-0 m-3">
                            <span class="badge bg-<?php echo e($event->status == 'active' ? 'success' : 'secondary'); ?> px-3 py-2">
                                <?php echo e($event->status == 'active' ? 'Aktif' : 'Selesai'); ?>
                    ...
                    <div class="event-content p-4">
                        <div class="event-meta mb-3">
                            <div class="d-flex align-items-center text-muted small mb-2">
                                ...
                                <span><?php echo e(\Carbon\Carbon::parse($event->start_date)->format('d M Y')); ?></span>
                            </div>
                        ...
                        <h5 class="fw-bold mb-3"><?php echo e($event->title); ?></h5>
                        <p class="text-muted mb-4"><?php echo e(Str::limit($event->description, 100)); ?></p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="event-price">
                                <?php if($event->price > 0): ?>
                                    <span class="fw-bold text-primary">Rp <?php echo e(number_format($event->price, 0, ',', '.')); ?></span>
                                <?php else: ?>
...
<?php if($latestProducts && $latestProducts->count() > 0): ?>
<div class="products-section py-5">
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $latestProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 col-md-6">
                <div class="product-card bg-white rounded-4 shadow-sm h-100 overflow-hidden transition-all">
                    <div class="product-image-container position-relative">
                        <?php if($produk->image): ?>
                            <img src="<?php echo e(asset('uploads/'.$produk->image)); ?>" class="img-fluid w-100" style="height: 200px; object-fit: cover;" alt="<?php echo e($produk->name); ?>">
                        <?php else: ?>
                            <div class="bg-primary d-flex align-items-center justify-content-center" style="height: 200px;">
                        ...
                        <div class="product-badge position-absolute top-0 end-0 m-3">
                            <span class="badge bg-<?php echo e($produk->status == 'active' ? 'success' : 'secondary'); ?> px-3 py-2">
                                <?php echo e($produk->status == 'active' ? 'Tersedia' : 'Habis'); ?>

                            </span>
                        </div>
                    </div>
                    <div class="product-content p-4">
                        <h5 class="fw-bold mb-3"><?php echo e($produk->name); ?></h5>
                        <p class="text-muted mb-4"><?php echo e(Str::limit($produk->description, 100)); ?></p>
                        
                        <?php if($produk->features): ?>
                        <div class="product-features mb-4">
                            <h6 class="fw-bold text-primary mb-2">Fitur:</h6>
                            <ul class="list-unstyled small text-muted">
                                <?php $__currentLoopData = explode(',', $produk->features); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="mb-1"><i class="bi bi-check-circle text-success me-2"></i><?php echo e(trim($feature)); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="product-price">
                                <span class="fw-bold text-primary fs-5">Rp <?php echo e(number_format($produk->price, 0, ',', '.')); ?></span>
                            </div>
...
<?php if($latestGallery && $latestGallery->count() > 0): ?>
<div class="gallery-preview py-5" style="background: #f8f9fa;">
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $latestGallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-4">
                <div class="gallery-item rounded-4 overflow-hidden shadow-sm">
                    <?php if($gallery->image): ?>
                        <img src="<?php echo e(asset('uploads/'.$gallery->image)); ?>" 
                    ...
                    <div class="gallery-overlay p-3 bg-white">
                        <h5 class="fw-bold mb-2"><?php echo e($gallery->title); ?></h5>
                        <p class="text-muted small mb-0"><?php echo e(Str::limit($gallery->description, 80)); ?></p>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Nacht\Downloads\Himakom (4) (1)\Himakom\resources\views/home.blade.php ENDPATH**/ ?>