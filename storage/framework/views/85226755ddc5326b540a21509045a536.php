...
<head>
    ...
    <?php endif; ?>
    <?php echo $__env->yieldContent('extra_meta'); ?>
    ...
    <?php if (! empty(trim($__env->yieldContent('jsonld')))): ?>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('profile')); ?>"><i class="bi bi-person me-1"></i> Profil</a></li>
                                <li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('orders.history')); ?>"><i class="bi bi-cart me-1"></i> Riwayat Pesanan</a></li>
                                <li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('event-registrations.history')); ?>"><i class="bi bi-calendar-check me-1"></i> Event Saya</a></li>
                                <li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('certificates.index')); ?>"><i class="bi bi-award me-1"></i> Sertifikat Saya</a></li>
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center" href="<?php echo e(route('register')); ?>">
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <div class="d-flex">
                        <?php if($footerKontak && $footerKontak->instagram): ?>
                            <a href="<?php echo e($footerKontak->instagram); ?>" target="_blank" class="btn btn-outline-light btn-sm me-2 rounded-circle" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                                <i class="bi bi-instagram"></i>
                            </a>
                        <?php endif; ?>
                        <?php if($footerKontak && $footerKontak->facebook): ?>
                            <a href="<?php echo e($footerKontak->facebook); ?>" target="_blank" class="btn btn-outline-light btn-sm me-2 rounded-circle" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                                <i class="bi bi-facebook"></i>
                            </a>
                        <?php endif; ?>
                        <?php if($footerKontak && $footerKontak->youtube): ?>
                            <a href="<?php echo e($footerKontak->youtube); ?>" target="_blank" class="btn btn-outline-light btn-sm me-2 rounded-circle" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                                <i class="bi bi-youtube"></i>
                            </a>
                        <?php endif; ?>
                        <?php if($footerKontak && $footerKontak->linkedin): ?>
                            <a href="<?php echo e($footerKontak->linkedin); ?>" target="_blank" class="btn btn-outline-light btn-sm me-2 rounded-circle" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                                <i class="bi bi-linkedin"></i>
                            </a>
                        <?php endif; ?>
                        <?php if($footerKontak && $footerKontak->tiktok): ?>
                            <a href="<?php echo e($footerKontak->tiktok); ?>" target="_blank" class="btn btn-outline-light btn-sm rounded-circle" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="mb-3">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <span class="text-light">
                                <?php if($footerKontak && $footerKontak->address): ?>
                                    <?php echo e($footerKontak->address); ?>
                        ...
                        <?php if($footerKontak && $footerKontak->email): ?>
                            <div class="d-flex align-items-center mb-2">
                                <i class="bi bi-envelope-fill me-3 text-primary"></i>
                                <a href="mailto:<?php echo e($footerKontak->email); ?>" class="text-light text-decoration-none"><?php echo e($footerKontak->email); ?></a>
                            </div>
                        <?php endif; ?>
                        <?php if($footerKontak && $footerKontak->phone): ?>
                            <div class="d-flex align-items-center mb-2">
                                <i class="bi bi-telephone-fill me-3 text-primary"></i>
                                <a href="tel:<?php echo e($footerKontak->phone); ?>" class="text-light text-decoration-none"><?php echo e($footerKontak->phone); ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="text-light mb-0">
                        &copy; <?php echo e(date('Y')); ?> HIMAKOM Universitas Yatsi Madani. All rights reserved.
                    </p>
                </div>
...
</html> <?php /**PATH C:\Users\Nacht\Downloads\Himakom (4) (1)\Himakom\resources\views/layout.blade.php ENDPATH**/ ?>