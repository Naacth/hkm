...
<?php $__env->startSection('page-title', 'Kelola Event'); ?>
...
<div class="content-section py-5">
    <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="stats-info">
                        <h4 class="fw-bold text-primary mb-1">Total Event: <?php echo e($events->count()); ?></h4>
                        <p class="text-muted mb-0">Event yang tersedia dalam sistem</p>
                    </div>
                </div>
                <div class="col-md-6 text-md-end">
                    <a href="<?php echo e(route('events.create')); ?>" class="btn btn-success btn-lg rounded-pill">
                        ...
                        <tr class="event-row">
                            ...
                            <td class="px-4 py-3">
                                <div class="event-info">
                                    ...
                                    <p class="text-muted small mb-0"><?php echo e(Str::limit($event->description, 60)); ?></p>
                                </div>
                            </td>
                            <td class="px-4 py-3">
                                <div class="date-info">
                                    <span class="badge bg-primary rounded-pill px-3 py-2">
                                        <i class="bi bi-calendar me-1"></i><?php echo e(\Carbon\Carbon::parse($event->date)->format('d M Y')); ?>
                            ...
                            <td class="px-4 py-3">
                                <?php if($event->location): ?>
                                    <span class="text-muted">
                                        <i class="bi bi-geo-alt me-1"></i><?php echo e(Str::limit($event->location, 30)); ?>
                                ...
                                <?php if($event->image): ?>
                                    <div class="event-image-container">
                                        <img src="<?php echo e(asset('uploads/'.$event->image)); ?>" 
                                             ...
                                             data-bs-target="#imageModal<?php echo e($event->id); ?>"
                                             style="cursor: pointer;">
                                    </div>
                                    
                                    <!-- Image Modal -->
                                    <div class="modal fade" id="imageModal<?php echo e($event->id); ?>" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content border-0 shadow-lg">
                                                <div class="modal-header border-0 bg-primary text-white">
                                                    <h5 class="modal-title fw-bold"><?php echo e($event->title); ?></h5>
                            ...
                            <td class="px-4 py-3">
                                <div class="action-buttons">
                                    <a href="<?php echo e(route('admin.events.participants', $event)); ?>" 
                                    ...
                                    <button type="button" 
                                            ...
                                            onclick="confirmDelete('<?php echo e($event->id); ?>', '<?php echo e($event->title); ?>')"
                                            title="Hapus Event">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                    
                                    <!-- Delete Form -->
                                    <form id="deleteForm<?php echo e($event->id); ?>" 
                                          action="<?php echo e(route('events.destroy', $event)); ?>" 
                                          method="POST" 
                                          class="d-none">
        ...
        <div class="empty-state text-center py-5">
            ...
            <a href="<?php echo e(route('events.create')); ?>" class="btn btn-primary btn-lg rounded-pill">
        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6">
                <div class="stat-card bg-white rounded-4 p-4 text-center shadow-sm">
                    ...
                    <h3 class="fw-bold text-primary mb-2"><?php echo e($events->count()); ?></h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-card bg-white rounded-4 p-4 text-center shadow-sm">
                    ...
                    <h3 class="fw-bold text-success mb-2"><?php echo e($events->where('date', '>=', now())->count()); ?></h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-card bg-white rounded-4 p-4 text-center shadow-sm">
                    ...
                    <h3 class="fw-bold text-warning mb-2"><?php echo e($events->where('date', '<', now())->count()); ?></h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-card bg-white rounded-4 p-4 text-center shadow-sm">
                    ...
                    <h3 class="fw-bold text-info mb-2"><?php echo e($events->whereNotNull('image')->count()); ?></h3>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Nacht\Downloads\Himakom (4) (1)\Himakom\resources\views/admin/events/index.blade.php ENDPATH**/ ?>